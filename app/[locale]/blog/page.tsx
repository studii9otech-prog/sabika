  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 pb-20 space-y-10">
        ...
        {featuredArticle && (
          <div className="group relative rounded-2xl border border-border/60 bg-card hover:border-primary/30 transition-all duration-300 shadow-xl overflow-hidden text-start">
            {/* Subtle glow */}
            ...
            <div className="relative z-10 grid grid-cols-1 lg:grid-cols-12">
              {/* Left/Graphic side */}
              <div className="lg:col-span-5 bg-muted/40 dark:bg-zinc-900/30 border-b lg:border-b-0 lg:border-e border-border/40 p-8 sm:p-10 flex flex-col justify-between relative overflow-hidden min-h-[200px]">
        ...
        {gridArticles.length > 0 ? (
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-start">
            {gridArticles.map((article) => (
              <div
                key={article.slug}
                className="group bg-card border border-border/60 hover:border-primary/30 rounded-2xl p-6 hover:shadow-lg hover:-translate-y-1 transition-all duration-300 flex flex-col justify-between gap-6 relative overflow-hidden"
              >
                <div className="space-y-4">
                  ...
                  <div className="space-y-2">
                    <h3 className="text-base sm:text-lg font-bold text-foreground leading-snug group-hover:text-primary transition-colors font-heading">
                ...
                <div className="flex items-center justify-between pt-4 border-t border-border/30">
                  <div className="flex items-center gap-2">
                    <div className="w-7 h-7 rounded-full bg-muted border border-border flex items-center justify-center font-bold text-[10px] text-foreground">
