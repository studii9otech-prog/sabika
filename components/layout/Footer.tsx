          ...
          <div className="md:col-span-4 space-y-5">
            ...
            <div className="flex items-center gap-2 pt-2">
              <a
                ...
                className="w-8 h-8 rounded-xl bg-white/[0.03] border border-white/[0.08] hover:border-primary/50 hover:bg-primary/10 flex items-center justify-center text-zinc-400 hover:text-primary transition-all duration-200 cursor-pointer"
                aria-label="Twitter"
              >
