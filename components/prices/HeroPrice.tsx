...
export default function HeroPrice() {
  ...
  return (
    <div ref={containerRef} className="px-6 pt-10 pb-6 max-w-2xl mx-auto">
      ...
      {/* ── Recharts AreaChart ───────────────────────────────────── */}
      <div className="g-fade w-full h-[150px] mb-6 select-none" style={{ marginLeft: '-4px', marginRight: '-4px', width: 'calc(100% + 8px)' }}>
        <ResponsiveContainer width="100%" height="100%">
          <AreaChart 
            data={chartData} 
            margin={{ top: 10, right: isAr ? 0 : 4, left: isAr ? 4 : 0, bottom: 0 }}
            onMouseMove={(state) => {
